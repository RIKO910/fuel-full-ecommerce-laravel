...
<style>
    /* .cover {
        background-image: url('{{ asset('images/' . (optional($company)->cantactbackground ?? 'default_background.jpg')) }}');
...
<div class="mb-5 cover">
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-12 ">
                <h2 class="mt-5 mb-4 text-center text-white">{{ __('language.quick') }}</h2>
                <form action="" method="POST">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-md-3">
                                <button type="submit"
                                    class="mb-5 btn btn-primary btn-block custom-btn">{{ __('language.send') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
