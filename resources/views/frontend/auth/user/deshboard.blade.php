        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="fm-menu">
                            <div class="list-group list-group-flush">
                                <h5 class="my-3">Hello, {{ Auth::user()->name ?? '' }}</h5>
                                <button id="personalInfoButton" class="list-group-item py-1" onclick="showPersonalInfo()"><i
                                        class='bx bx-folder me-2'></i><span>Personal Information</span></button>
                                <button class="list-group-item py-1" onclick="fetchMyOrders()"><i
                                        class='bx bx-folder me-2'></i><span>My Order</span></button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-8 m-3">
                <div id="personalInfoCard" class="card" style="display: none;">
                    <div class="card-body">
                        <header class="card-header">
                            <h4 class="card-title mt-2">My Personal Information</h4>
                ...
                <div id="orderCard" class="card" style="display: none;">
                    <div class="card-body">
                        <header class="card-header">
                            <h4 class="card-title mt-2">My All Order</h4>
                        </header>
                        <article class="card-body">
